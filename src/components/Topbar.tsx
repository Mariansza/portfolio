      ...
      <div className="text-mute flex flex-wrap items-center justify-between gap-4 px-6 py-6 font-mono text-xs lg:px-14">
        ...
        >
          <Link
            ...
            className={`inline-flex items-center gap-1.5 rounded-[3px] border px-3 py-1.5 transition-colors active:scale-95 ${
              pathname === '/'
          ...
          {navItems.map((item) => {
            ...
            return (
              <Link
                ...
                className={`group inline-flex items-center rounded-[3px] border px-3 py-1.5 transition-colors active:scale-95 ${
                  isActive
                    ? 'border-accent/45 bg-accent/[0.08] text-fg-bright'
                    : 'border-mute-soft bg-fg/[0.03] text-mute hover:border-mute hover:bg-fg/[0.06] hover:text-fg-bright'
                }`}
